...
if ($NL<>"") {
$SQL1="SELECT* FROM leyesnv  WHERE NL LIKE '$NL'  ORDER BY NL ASC";

}if ($Voz<>"") {
$SQL1="SELECT* FROM leyesnv WHERE Voz LIKE '%$Voz%' ORDER BY NL ASC";

}if ($Subvoz<>"") {
$SQL1="SELECT* FROM leyesnv WHERE Subvoz LIKE '%$Subvoz%' ORDER BY NL ASC";

}if ($Extracto<>"") {
$SQL1="SELECT* FROM leyesnv WHERE Extracto LIKE '%$Extracto%' ORDER BY NL ASC";

}if ($Sancion<>"") {
$SQL1="SELECT* FROM leyesnv WHERE Sancion LIKE '%$Sancion%' ORDER BY NL ASC";

}if ($Promulgacion<>"") {
$SQL1="SELECT* FROM leyesnv WHERE Promulgacion LIKE '%$Promulgacion%' ORDER BY NL ASC";

}if ($Observaciones<>"") {
$SQL1="SELECT* FROM leyesnv WHERE Observaciones LIKE '%Observaciones%' ORDER BY NL ASC";

}if ($PBO<>"") {
$SQL1="SELECT* FROM leyesnv WHERE PBO LIKE '%$PBO%' ORDER BY NL ASC";

}if ($es<>"") {
$SQL1="SELECT* FROM leyesnv WHERE es LIKE '%$es%' ORDER BY NL ASC";

}if ($materia<>"") {
$SQL1="SELECT* FROM leyesnv WHERE materia LIKE '%$materia%' ORDER BY NL ASC";

}if ($nlm<>"") {
$SQL1="SELECT* FROM leyesnv WHERE nlm LIKE '%$nlm%' ORDER BY NL ASC";

}if ($modi<>"") {
$SQL1="SELECT* FROM leyesnv WHERE modi LIKE '%$modi%' ORDER BY NL ASC";

}if ($regla<>"") {
$SQL1="SELECT* FROM leyesnv WHERE regla LIKE '%$regla%' ORDER BY NL ASC";
...
echo '<div class="alert alert-success" role="alert">Se han encontrado '.$numero.' registros de leyes no vigentes (NV)</div>';
...
echo "<h4><a href='http://www.hcdcorrientes.gov.ar/Leyes-texto/Ley$valor2.pdf' target='_BLANK'>Ley Nº ".utf8_decode($row['NL'])." (".utf8_decode($row['estado']).")</a></h4>"; 
...
?>
	...
	<script language="JavaScript">
		...
		alert("ESTA LEY O DECRETO LEY QUE ESTA CONSULTANDO ESTA VIGENTE");
	</script>
